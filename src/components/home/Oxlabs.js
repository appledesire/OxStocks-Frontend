...
const Oxlabs = () => {
    useEffect(() => {
      ...
      const { firstname, lastname, email, idea } = formData;
                    ...
                    <div className="container">
                        <div className="offset-xl-3 col-xl-6 offset-md-2 col-md-8 oxlabs_contact_form">
                            ...
                            <form id="idea_form">
                                ...
                                <div className="col-md-6">
                                    <input type="text" className="form-control" id="firstname" name="firstname" onChange={onChange} placeholder="First Name" />
                                </div>
                                <div className="col-md-6">
                                    <input type="text" className="form-control" id="lastname" name="lastname" onChange={onChange} placeholder="Last Name" />
                                </div>
                                </div>
                                <div className="row oxlabs_msg_input_box">
                                    <div className="col-md-12">
                                ...
                                <div className="row oxlabs_msg_input_box">
                                    <div className="col-md-12">
                                        <textarea className="form-control" placeholder="Idea" id="idea" name="idea" onChange={onChange} style={{height: '200px'}}></textarea>
                                    </div>
                                </div>
                            </form>
                            
                            <div className="oxlabs_submit_form"><button type="button" className="oxlabs_submit_btn" onClick={(e) => onSubmit(e)}>Submit</button></div>
                            </Fade>
