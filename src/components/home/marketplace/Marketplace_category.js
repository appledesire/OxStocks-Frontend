              ...
              <div className="col-xl-3 col-md-3 col-sm-12">
                <div className="category_box">
                  ...
                  <div className="checkout">
                    <p className="box">
                      <input type="checkbox" className="category_icon" />
                      <span className="category_text"> NFT </span>
                    </p>
                    <p className="box">
                      <input type="checkbox" className="category_icon" />
                      <span className="category_text"> Domains </span>
                    </p>
                    <p className="box">
                      <input type="checkbox" className="category_icon" />
                      <span className="category_text"> Tech </span>
                    </p>
                    <p className="box">
                      <input type="checkbox" className="category_icon" />
                      <span className="category_text"> Apparel </span>
                    </p>
                    <p className="box">
                      <input type="checkbox" className="category_icon" />
                      <span className="category_text"> Misc </span>
                    </p>
                  </div>
                </div>
                <div className="category_box">
                  ...
                  <div className="checkout">
                    <p className="box">
                      <input type="checkbox" className="category_icon" />
                      <span className="category_text"> Buy Now </span>
                    </p>
                    <p className="box">
                      <input type="checkbox" className="category_icon" />
                      <span className="category_text"> Action </span>
                    </p>
                    <p className="box">
                      <input type="checkbox" className="category_icon" />
                      <span className="category_text"> Sold </span>
                    </p>
                  </div>
                </div>
                <div>
                  <button className="btn btn-warning apply-categories">Apply</button>
                </div>
              </div>
            </Fade>
