        ...
        <div className="container">
          ...
          <Fade right>
            <div className="row market_logo_title">
              ...
              <p className="market_logo_title3">
                Get paid in Ox Coin when selling your assets with us.
              </p>
              <Link to="/marketplaceCategory">
                ...
                <div className="market_item">
                  <Link to="/marketplaceDetail">
                    <div className="market_item_top">
                      <img
                        className="img-fluid"
                        src="assets/img/market/iconox.png"
                        width="120px"
                        height="120px"
                        alt=""
                      />
            ...
            <div className="row">
              ...
              <div className="col-xl-3 col-md-3">
                <div className="market_shop_box">
                  <img
                    className="img-fluid"
                    src="assets/img/market/Domains.png"
                    alt=""
                  />
              ...
              <div className="col-xl-3 col-md-3">
                <div className="market_shop_box">
                  <img
                    className="img-fluid"
                    src="assets/img/market/Technical.png"
                    alt=""
                  />
              ...
              <div className="col-xl-3 col-md-3">
                <div className="market_shop_box">
                  <img
                    className="img-fluid"
                    src="assets/img/market/Appanel.png"
                    alt=""
                  />
            ...
            <div className="row">
              <div className="col-xl-4 col-md-6 col-sm-12">
                <div className="market_sell_box">
                  <img
                    className="img-fluid"
                    src="assets/img/market/wide.png"
                    alt=""
                  />
                  <div className="market_sell_box_label">
                    <p className="text1">Wide Range</p>
                    <p className="text2">
                      We have a large range of digital assets including NFT’s,
                      Websites, Domains and Music.
                    </p>
                  </div>
                </div>
              </div>
              <div className="col-xl-4 col-md-6 col-sm-12">
                <div className="market_sell_box">
                  ...
                  <div className="market_sell_box_label">
                    ...
                    <p className="text2">
                      By using Ox Coin, you can confidently buy and sell on our
                      marketplace.
                    </p>
                  </div>
                </div>
              ...
              <div className="col-xl-4 col-md-6 col-sm-12">
                <div className="market_sell_box">
                  ...
                  <div className="market_sell_box_label">
                    ...
                    <p className="text2">
                      Create an account to keep your digital assets safe with
                      your Ox Wallet
                    </p>
                  </div>
                </div>
