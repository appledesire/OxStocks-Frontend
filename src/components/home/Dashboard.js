                ...
                {/* <Bounce top  delay = { 500 } duration = { 1000 }><img className="img-fluid dash_building_santa_icon" src="assets/img/index/santa.png" width="25%" height="25%" alt="" /></Bounce> */}
                    <div className="container">
                        ...
                        <div className="row dash_building_panel">
                            ...
                            <div>
                                <Bounce top  delay = { 4500 } duration = { 1000 }><img className="img-fluid dash_building_btc_icon" src="assets/img/crypto/bitcoin.png" width="4%" height="4%" alt="" /></Bounce>
                                <Bounce top  delay = { 2500 } duration = { 1000 }><img className="img-fluid dash_building_eth_icon" src="assets/img/crypto/litecoin.png" width="4%" height="4%" alt="" /></Bounce>
                                <Bounce top  delay = { 2000 } duration = { 1000 }><img className="img-fluid dash_building_bnb_icon" src="assets/img/crypto/eth.png" width="4%" height="4%" alt="" /></Bounce>
                                <Bounce top  delay = { 3500 } duration = { 1000 }><img className="img-fluid dash_building_usdt_icon" src="assets/img/crypto/tether.png" width="4%" height="4%" alt="" /></Bounce>
                                <Bounce top  delay = { 1000 } duration = { 1000 }><img className="img-fluid dash_building_ox_icon" src="assets/img/crypto/oxcoin.png" width="6%" height="6%" alt="" /></Bounce>
                                <Bounce top  delay = { 4000 } duration = { 1000 }><img className="img-fluid dash_building_euro_icon" src="assets/img/crypto/euro.png" width="4%" height="4%" alt="" /></Bounce>
                                <Bounce top  delay = { 3000 } duration = { 1000 }><img className="img-fluid dash_building_gbp_icon" src="assets/img/crypto/gbp.png" width="4%" height="4%" alt="" /></Bounce>
                            </div>
