                ...
                <div className="privacy_section_2">
                    <div className="container">
                        ...
                        <div className="panel5">
                            ...
                            <p className="privacy_subtitle">(c) We may also use your personal information to protect the copyright, trademarks, legal rights, property or safety of OX STOCKS PTY LTD, ox-stocks.com, its customers or third parties.</p>
