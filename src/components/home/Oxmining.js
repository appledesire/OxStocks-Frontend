                ...
                <div className="container">
                    ...
                    <div className="row header_section">
                        <div className="col-xl-6">
                            ...
                            <p className="title2">OX Coin is built on its own blockchain (OX Chain). OX Coin will provide tremendous benefits to society ensuring secure data ownership in a decentralised way to connect the world without intermediates benefiting the end users of all types of communications
                            </p>
                        </div>
                        <div className="col-xl-6">
