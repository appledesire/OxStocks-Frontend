                    ...
                    <div className="row">
                        <div className="col-xl-8 col-md-7 col-sm-12">
                            <div className="box">
                                ...
                                <div><img className="img-fluid" src={new_detail.image} alt=""/></div>
                                <p className="title2">{ new Date(new_detail.date).getDate() + " " + (new Date(new_detail.date).getMonth() + 1) + " " + new Date(new_detail.date).getFullYear() }</p>
                                <p className="title3 news_details_dvi" dangerouslySetInnerHTML={{ __html: new_detail.body }}></p>
                            </div>
                        </div>
