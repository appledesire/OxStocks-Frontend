  ...
  return (
    <Fragment>
      ...
      <Accordion.Item eventKey="0">
        ...
        <Accordion.Body>
          We are an Australian company who are extremely passionate about crypto and the future of our financial systems
        </Accordion.Body>
      </Accordion.Item>
      <Accordion.Item eventKey="1">
        <Accordion.Header>Where can I buy OX Coin?</Accordion.Header>
        <Accordion.Body>
          Ox Coin will be available for purchase from xt.com on the 8th of March 2023
        </Accordion.Body>
      </Accordion.Item>
