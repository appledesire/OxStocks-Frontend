...
const Nav = ({ isAuthenticated, logout }) => {
  ...
  return (
    <div
      className="nav_box"
      style={{ height: "auto", backgroundColor: "#1d1e21 !important" }}
    >
      <Link to="/">
        <label
          style={{
      ...
      <label
        className="font-white dropdown-toggle"
        style={{
          fontSize: "1.2rem",
          fontFamily: "NexaLight",
          color: "white",
                ...
                <Link to="/aboutus">
                  <div className="content">
                    ...
                    <span className="detail">
                      Discover the story behind OX STOCKS as a company, beliefs
              ...
              <td style={{ width: "33.3%" }}>
                <Link to="/location">
                  <div className="content1">
                    ...
                    <span className="detail">
                      Find our Global Offices & Representatives.
                    </span>
                  </div>
                </Link>
              </td>
              ...
              <td>
                <Link to="/referral">
                  <div className="content1">
                    ...
                    <span className="detail">
                      Be paid to refer people to our platform.
                    </span>
                  </div>
                </Link>
              </td>
      ...
      >
        <div style={{ width: "800px", height: "400px", display: "flex" }}>
          ...
          <tr>
              ...
              <td style={{ width: "33.3%" }}>
                <Link to="/ERC20Crypto">
                  <div className="content1 content-prepare">
                    <p className="title">Buy ERC20 Crypto</p>
                    <span className="detail">
                      Let's add some crypto to your OX Wallet
                    </span>
                    <span className="nav-date" style={{ marginTop: "20px" }}>
                      March 2023
                    </span>
              ...
              <td>
                <Link to="/oxmining">
                  <div className="content1 content-prepare">
                    ...
                    <span className="detail">
                      Cloud Mining Platform Available For All Devices.
                    </span>
                    <span className="nav-date" style={{ marginTop: "20px" }}>
                      March 2023
                    </span>
            ...
            <tr>
              ...
              <td>
                  <div className="content1">
                    ...
                    <span className="detail">
                      Our public blockchain explorer{" "}<br/><br/>
                      Coming Soon
                    </span>
                  </div>
              </td>
              ...
              <td rowSpan={2} style={{ width: "33.3%" }}>
                <Link to="/oxlabs">
                  <div className="content">
                    ...
                    <span className="detail">
                      Where our engineers live and work 24/7. Browse our
                      upcoming projects and reach out to us if you have a crypto
                      project idea.
                    </span>
                  </div>
                </Link>
              ...
              <td rowSpan={2} style={{ width: "33.3%" }}>
                <Link to="/roadmap">
                  <div className="content">
                    ...
                    <span className="detail">
                      Learn everything about our crypto currency and the future
                      of digital currencies. Pick up some useful tips when using
                      our platform.
                    </span>
                  </div>
                </Link>
